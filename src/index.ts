...
export declare function $$readFile<T = Record<string, unknown>>(
  path: string,
  parseJSON?: boolean,
): T
 ...
 * @category Built-in Macros
 */
export declare function $$inline<F extends (...args: any) => any>(
  func: F,
  params: Parameters<F>,
  doNotCall: any,
): () => ReturnType<F>
...
export declare function $$raw<T>(
  fn: (ctx: RawContext, ...args: any[]) => ts.Node | ts.Node[] | undefined,
): T
...
export declare function $$map<T>(
  exp: T,
  mapper: (value: any, kind: number) => any,
): T
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export declare function $$typeMetadata<T>(
  collectProps?: boolean,
  collectMethods?: boolean,
): TypeMedatada
